  ...
  if(minTemp == true){ // Draws the minTemp to the graph for each month
    ...
    if(Jan == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){ // Creates the scatterPlot for January
          circle((3*(12*i))+55,400+(-8*(TemperatureDataArray[12*i].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Feb == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+1))+55,400+(-8*(TemperatureDataArray[(12*i)+1].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Mar == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+2))+55,400+(-8*(TemperatureDataArray[(12*i)+2].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Apr == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+3))+55,400+(-8*(TemperatureDataArray[(12*i)+3].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(May == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+4))+55,400+(-8*(TemperatureDataArray[(12*i)+4].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Jun == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+5))+55,400+(-8*(TemperatureDataArray[(12*i)+5].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Jul == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+6))+55,400+(-8*(TemperatureDataArray[(12*i)+6].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Aug == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+7))+55,400+(-8*(TemperatureDataArray[(12*i)+7].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Sep == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+8))+55,400+(-8*(TemperatureDataArray[(12*i)+8].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Oct == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+9))+55,400+(-8*(TemperatureDataArray[(12*i)+9].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Nov == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+10))+55,400+(-8*(TemperatureDataArray[(12*i)+10].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
    ...
    if(Dec == true){
      for(int i = 0; i < 29; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+11))+55,400+(-8*(TemperatureDataArray[(12*i)+11].MinT)),2.5);
        }
        if(snowfall == true){
          fill(255);
          stroke(150);
  ...
  if(maxTemp == true){ // Draws the maxTemp to the graph for each month
    ...
    if(Jan == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*(12*i))+55,400+(-8*(TemperatureDataArray[12*i].MaxT)),2.5);
        }
      }
    }
    if(Feb == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+1))+55,400+(-8*(TemperatureDataArray[(12*i)+1].MaxT)),2.5);
        }
      }
    }
    if(Mar == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+2))+55,400+(-8*(TemperatureDataArray[(12*i)+2].MaxT)),2.5);
        }
      }
    }
    if(Apr == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+3))+55,400+(-8*(TemperatureDataArray[(12*i)+3].MaxT)),2.5);
        }
      }
    }
    if(May == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+4))+55,400+(-8*(TemperatureDataArray[(12*i)+4].MaxT)),2.5);
        }
      }
    }
    if(Jun == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+5))+55,400+(-8*(TemperatureDataArray[(12*i)+5].MaxT)),2.5);
        }
      }
    }
    if(Jul == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+6))+55,400+(-8*(TemperatureDataArray[(12*i)+6].MaxT)),2.5);
        }
      }
    }
    if(Aug == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+7))+55,400+(-8*(TemperatureDataArray[(12*i)+7].MaxT)),2.5);
        }
      }
    }
    if(Sep == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+8))+55,400+(-8*(TemperatureDataArray[(12*i)+8].MaxT)),2.5);
        }
      }
    }
    if(Oct == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+9))+55,400+(-8*(TemperatureDataArray[(12*i)+9].MaxT)),2.5);
        }
      }
    }
    if(Nov == true){
      for(int i = 0; i < 30; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+10))+55,400+(-8*(TemperatureDataArray[(12*i)+10].MaxT)),2.5);
        }
      }
    }
    if(Dec == true){
      for(int i = 0; i < 29; i++){
        ...
        if(scatterPlot == true){
          circle((3*((12*i)+11))+55,400+(-8*(TemperatureDataArray[(12*i)+11].MaxT)),2.5);
        }
      }
    }
    stroke(255);
...
void axis(){ // Draws the x/y axis and it's labels
  fill(255);
  stroke(255);
  line(50,0,50,600); // X
...
void barChart(){ // Changes from scatterPlot to barChart when the button is pressed
  barChart = true;
  scatterPlot = false;
  snowfall = false;
  sortByYear = false;
...
void scatterPlot(){ // Changes from barChart to scatterPlot when the button is pressed
  barChart = false;
  scatterPlot = true;
  snowfall = false;
  sortByYear = false;
...
void sortByYear(){ // Changes to year view
  barChart = false;
  scatterPlot = false;
  snowfall = false;
  sortByYear = true;
...
void pieChart(float diameter, float[] data) {
  ...
  for (int i = 0; i < data.length; i++) {
    if (i==0){
      fill(255,0,0);
      text("Number of months warmer than "+customTemp+"ºC = "+int(hotMonths),768,145);
    }
    else{
      fill(0,0,255);
      text("Number of months colder than "+customTemp+"ºC = "+int(coldMonths),768,165);
    }
